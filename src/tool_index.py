...
BUILTIN_TOOL_DESCRIPTIONS: Dict[str, str] = {
    ...
    "find_images": "Find VERIFIED open-license image URLs for a subject (Wikimedia Commons), already checked live (HTTP 200) — use the returned URLs directly in HTML/markdown. Always use this to get real images; never invent image URLs and never scrape image pages by hand. Use for 'find a picture of X', 'add real images to the page'.",
}
