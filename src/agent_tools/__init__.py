...
from .web_tools import WebSearchTool, WebFetchTool, FindImagesTool
...
from .bg_job_tools import ManageBgJobsTool, ManageServerTool
from .framework_tools import ManageFrameworkTool
...
TOOL_HANDLERS = {
    ...
    "find_images": FindImagesTool().execute,
    ...
    "manage_server": ManageServerTool().execute,
    "manage_framework": ManageFrameworkTool().execute,
...
TOOL_TAGS = {"bash", "python", "web_search", "web_fetch", "find_images", "read_file", "write_file", "edit_file",
             "apply_patch", "todowrite",
             "grep", "glob", "ls", "get_workspace", "manage_bg_jobs", "manage_server",
             "manage_framework",
